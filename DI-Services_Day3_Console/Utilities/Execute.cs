...
namespace DI_Services_Day3_Console.Utilities
{
    public class Execute
    {
        ...
        #region runProgram
        public static void RunMain(ref SVBusinessLogic svBL)
        {
            int pick = 0;
            bool check;
            do
            {
                ...
                switch (pick)
                {
                    ...
                    case 1:
                        ...
                        svBL.getAllInfoSinhVien();
                        break;
                    case 2:
                        svBL.getDetailOfSinhVienBy(svBL.setMaSVDoSomeThing());
                        break;
                    case 3:
                        svBL.getDetailTotalMonhoc(svBL.setMaSVDoSomeThing());
                        break;
                    case 4:
                        svBL.getScoreAllSinhVien();
                        break;
                    case 5:
                        svBL.setScoreSinhVien(svBL.setMaSVDoSomeThing());
                        break;
                    case 6:
